...
exports.EthChain = void 0;
var xchain_ethereum_1 = require("@xchainjs/xchain-ethereum");
var xchain_util_1 = require("@xchainjs/xchain-util");
var config_1 = require("../config");
var entities_1 = require("../entities");
var EthChain = /** @class */ (function () {
    function EthChain(_a) {
        var _this = this;
        ...
        this.transfer = function (tx) { return __awaiter(_this, void 0, void 0, function () {
            var assetAmount, recipient, memo, _a, feeOptionKey, asset, amount, txHash, error_4;
        ...
        this.chain = xchain_util_1.ETHChain;
        this.client = new xchain_ethereum_1.Client({
            network: network,
            phrase: phrase,
            etherscanApiKey: config_1.ETHERSCAN_API_KEY,
        });
    }
    /**
     * get xchain-binance client
     */
    EthChain.prototype.getClient = function () {
        return this.client;
    };
    Object.defineProperty(EthChain.prototype, "balance", {
        get: function () {
