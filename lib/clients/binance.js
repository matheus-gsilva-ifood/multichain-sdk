...
exports.BnbChain = void 0;
var xchain_binance_1 = require("@xchainjs/xchain-binance");
var xchain_util_1 = require("@xchainjs/xchain-util");
var entities_1 = require("../entities");
var BnbChain = /** @class */ (function () {
    function BnbChain(_a) {
        var _this = this;
        ...
        this.transfer = function (tx) { return __awaiter(_this, void 0, void 0, function () {
            var assetAmount, recipient, memo, asset, amount, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        assetAmount = tx.assetAmount, recipient = tx.recipient, memo = tx.memo;
         ...
         */
        this.multiSend = function (params) { return __awaiter(_this, void 0, void 0, function () {
            var assetAmount1, assetAmount2, recipient, memo, transactions, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        assetAmount1 = params.assetAmount1, assetAmount2 = params.assetAmount2, recipient = params.recipient, memo = params.memo;
                        transactions = [
                            {
                                to: recipient,
                                coins: [
                                    {
                                        ...
                                        amount: xchain_util_1.baseAmount(assetAmount1.amount.baseAmount),
                                    },
                                    {
                                        asset: {
                                        ...
                                        amount: xchain_util_1.baseAmount(assetAmount2.amount.baseAmount),
                                    },
                                ],
                            },
                        ];
                        return [4 /*yield*/, this.client.multiSend({
        ...
        this.chain = xchain_util_1.BNBChain;
        this.client = new xchain_binance_1.Client({
            network: network,
            phrase: phrase,
        });
    }
     ...
     */
    BnbChain.prototype.getClient = function () {
        return this.client;
    };
    Object.defineProperty(BnbChain.prototype, "balance", {
        get: function () {
