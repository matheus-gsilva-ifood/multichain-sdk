...
var ThorChain = /** @class */ (function () {
    ...
    Object.defineProperty(ThorChain.prototype, "balance", {
        get: function () {
    ...
    ThorChain.prototype.deposit = function (tx) {
        return __awaiter(this, void 0, void 0, function () {
            var assetAmount, memo, asset, amount, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        assetAmount = tx.assetAmount, memo = tx.memo;
                        asset = assetAmount.asset;
                        amount = xchain_util_1.baseAmount(assetAmount.amount.baseAmount);
                        if (!memo) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.client.deposit({
                                asset: {
                                    chain: asset.chain,
                                    symbol: asset.symbol,
                                    ticker: asset.ticker,
                    ...
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: throw new Error('Invalid Memo');
                    case 3:
                        error_5 = _a.sent();
